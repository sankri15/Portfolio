      ...
      <div className="flex items-center justify-between w-full max-w-[1400px] gap-[60px] z-10 flex-wrap">
        ...
        >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="wavy-btn glass-pill-btn mt-[28px] ml-[15px] px-[30px] py-[14px] border border-purple-500/60 text-purple-300 font-bold tracking-wide text-[16px] cursor-pointer shadow-[0_0_25px_rgba(168,85,247,0.6)] flex items-center gap-2 inline-flex"
            style={{ '--wavy-color': 'linear-gradient(to top, #ec4899, #a855f7)' }}
          >
            <span className="relative z-10 flex items-center gap-2">
