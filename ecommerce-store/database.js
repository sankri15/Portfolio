        ...
        db.run(`CREATE TABLE IF NOT EXISTS products (
            ...
            if (!err) {
                ...
                db.get("SELECT COUNT(*) AS count FROM products", (err, row) => {
                    if (row.count === 0) {
                        const insert = 'INSERT INTO products (name, description, price, image, category, brand) VALUES (?,?,?,?,?,?)';
                        const products = [
                            // Men
                            ...
                            ["Men's Leather Jacket", "Genuine leather biker jacket with zip details.", 4999, "https://images.unsplash.com/photo-1520975954732-57dd22299614?w=500&q=80", "Men", "US Polo"],
                            ...
                            ["Men's Formal Oxford Shoes", "Genuine leather formal oxford shoes for men.", 3299, "https://images.unsplash.com/photo-1614252209828-4b5b4c150bb6?w=500&q=80", "Footwear", "Bata"],
                            ...
                            ["Silver Pendant Necklace", "Minimalist sterling silver pendant necklace.", 1599, "https://images.unsplash.com/photo-1599643478514-4a42053960fb?w=500&q=80", "Accessories", "Swarovski"],
                            ...
                            ["Eyeshadow Palette", "12 color highly pigmented eyeshadow palette.", 1899, "https://images.unsplash.com/photo-1512496115851-a1c8524d0d22?w=500&q=80", "Beauty", "Maybelline"],
                            ...
                            ["Skincare Moisturizer", "Daily nourishing face moisturizer for all skin types.", 850, "https://images.unsplash.com/photo-1611078489935-0cb964de46d6?w=500&q=80", "Beauty", "Neutrogena"],
                            ...
                            ["Kids Winter Beanie", "Warm knitted winter beanie hat.", 399, "https://images.unsplash.com/photo-1544473244-f6895e69ce8d?w=500&q=80", "Kids", "Gap"],
                            ["Little Girl's Party Dress", "Beautiful ruffled party dress with bow detail.", 1599, "https://images.unsplash.com/photo-1618331835717-801e976710b2?w=500&q=80", "Kids", "Allen Solly Junior"],
                            ...
                            ["Kids Raincoat", "Waterproof colorful raincoat with hood.", 799, "https://images.unsplash.com/photo-1602030638412-bb8d20c51344?w=500&q=80", "Kids", "Mothercare"],
                            ["Girls Floral Headband", "Cute floral patterned soft headband for girls.", 299, "https://images.unsplash.com/photo-1529158062015-c64defbea271?w=500&q=80", "Kids", "Nauti Nati"],
                            ...
                            ["Velvet Decorative Pillows", "Set of 2 soft velvet throw pillow covers.", 699, "https://images.unsplash.com/photo-1584100936595-c0654b55a2e6?w=500&q=80", "Home", "IKEA"],
                        ...
                        // Seed Categories
                        const insertCat = 'INSERT INTO categories (name, image) VALUES (?,?)';
                        const categories = [
                        ...
                        db.serialize(() => {
                            categories.forEach(c => db.run(insertCat, c));
                        });
                        
                        // Admin user
                        const bcrypt = require('bcrypt');
                        bcrypt.hash('admin123', 10, (err, hash) => {
                            db.run("INSERT INTO users (name, email, password, role) VALUES ('Admin', 'admin@eshop.com', ?, 'admin')", [hash]);
                        });
                    }
                });
            }
